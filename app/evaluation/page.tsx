  ...
  return (
    <div className="p-6 md:p-10 max-w-[1200px] mx-auto space-y-8" style={{ background: '#ECE6E2' }}>
      ...
      <div className="border-b pb-6" style={{ borderColor: '#C4B5B0' }}>
        <div className="text-[10px] font-extrabold uppercase tracking-widest mb-1" style={{ color: '#990011' }}>AI Evaluation</div>
      ...
      <div className="rounded-2xl border p-8 text-center shadow-sm" style={{ background: '#E0D8D4', borderColor: '#C4B5B0' }}>
        <div className="text-[10px] font-extrabold uppercase tracking-widest mb-2" style={{ color: '#554B49' }}>Risk_Radar Golden Evaluation Set</div>
        ...
        <div className="text-sm mt-2 font-bold" style={{ color: '#176B52' }}>100% pass rate on our Risk_Radar evaluation benchmark</div>
        <p className="text-xs mt-1 max-w-md mx-auto font-medium" style={{ color: '#554B49' }}>
      ...
      <div className="rounded-2xl border p-5 space-y-3 shadow-sm" style={{ background: '#E0D8D4', borderColor: '#C4B5B0' }}>
        <div className="text-xs font-extrabold uppercase tracking-widest" style={{ color: '#111111' }}>Automated Security Benchmarking</div>
      ...
      <div className="rounded-2xl border overflow-hidden shadow-sm" style={{ background: '#E0D8D4', borderColor: '#C4B5B0' }}>
        <div className="px-5 py-4 border-b" style={{ borderColor: '#C4B5B0' }}>
          <div className="text-xs font-extrabold uppercase tracking-widest" style={{ color: '#111111' }}>Golden Corpus Sample Cases ({totalGoldenCases} Total)</div>
        </div>
