  ...
  return (
    <div className="p-6 md:p-10 max-w-[1200px] mx-auto space-y-8" style={{ background: '#ECE6E2' }}>
      ...
      <div className="border-b pb-6" style={{ borderColor: '#C4B5B0' }}>
        <div className="text-[10px] font-extrabold uppercase tracking-widest mb-1" style={{ color: '#990011' }}>Infrastructure</div>
        ...
        {services.map((svc) => {
          ...
          return (
            <div
              ...
              style={{
                background: isHealthy ? 'rgba(23,107,82,0.08)' : 'rgba(153,0,17,0.08)',
                borderColor: isHealthy ? 'rgba(23,107,82,0.25)' : 'rgba(153,0,17,0.25)',
              }}
            >
              <div className="flex items-center justify-between mb-2">
                <div className="font-bold text-sm" style={{ color: '#111111' }}>{svc.name}</div>
                <div
                  className="flex items-center gap-1.5 text-xs font-extrabold uppercase"
      ...
      <div className="rounded-2xl border p-6 space-y-3 shadow-sm" style={{ background: '#E0D8D4', borderColor: '#C4B5B0' }}>
        ...
        <div className="p-3.5 rounded-xl font-mono text-xs font-bold border shadow-xs" style={{ background: '#ECE6E2', borderColor: '#C4B5B0', color: '#990011' }}>
